 ...
 */ 
#define BIT(n) (0x01<<(n))
#define CALL_VBE 0x4F
#define INTERRUPT_VBE 0x10
#define SET_MODE_VBE 0x02
#define SET_LINEAR_FRAMEBUFFER BIT(14)
#define MIN_MODE 0x100
#define MAX_MODE 0x14c
...
typedef struct {
    char    VbeSignature[4];       /* 'VESA' signature */
	...
	short	reserved[222];			/* Reserved for VBE implementation scratch area */
...
/**
 * @brief Returns information on the input VBE controller
 * @param mode mode
 * @param vmi_p address of vbe_mode_info_t structure to be initialized
 * @return 0 on success, 1 otherwise
 */
